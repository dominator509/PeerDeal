...
class DemoScenarioCatalog {
  static const scenarios = <DemoScenario>[
    DemoScenario(
      ...
      description: 'Open Table live-hand shell with action bar, chat, and verification badge.',
      fixturePath: 'tools/demo_slice_fixtures/open_table_live_turn.json',
    ),
    DemoScenario(
      id: 'tournament_break',
      title: 'Tournament · Break',
      description: 'Tournament shell with break banner, paused action area, and seat summaries.',
    ...
    DemoScenario(
      ...
      description: 'Paused recovery shell with degraded network confidence and transfer messaging.',
    ...
    DemoScenario(
      ...
      description: 'Verification badge, receipt summary, and privacy/retention surfaces.',
