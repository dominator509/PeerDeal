...
- Sync recovery has in-memory and canonical JSON file-backed recovery-window
  ...
  persistence and route-specific live transport/source mounting remain
  production gaps; a bounded app source scheduler now exists around loaded
  native drains.
