...
| Mode/variant policy | `peerdeal_modes`, `peerdeal_variants` | Session mode policy and poker variant rules; mode governance bounds participant, seat, and waitlist collections before traversal; public variant result/state models defensively copy and freeze collections at the package boundary |
