...
| App flows | Demo routes plus mounted setup/join orchestration seams, app-owned native bootstrap mapping, and unknown-route fallback exist; production navigation polish remains |
