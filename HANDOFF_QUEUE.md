...
| `LEGACY-GAP-2026-06-13-006` | `.github/workflows/ci.yml` | 8 | T4 | OPEN | CI installs global Melos 7.5.1 while repo dependency is Melos 7.8.x; defer config change out of docs-only T1. |
