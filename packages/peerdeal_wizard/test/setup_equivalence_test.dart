...
void main() {
  group('Wizard equivalence', () {
    test('simple and conversational intents can converge on the same validated output', () {
      ...
      const conversational = SetupIntent(
        intentId: 'conv_1',
      ...
      final conversationalPlan = resolver.validateDraft(
        resolver.resolveIntent(intent: conversational, presetLayers: presetLayers),
      );
      ...
      expect(simplePlan.resolvedFields['seat_count'], conversationalPlan.resolvedFields['seat_count']);
    });
  });
}
